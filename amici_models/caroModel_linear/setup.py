...
def get_extension() -> Extension:
    ...
    sources = [os.path.join("swig", "caroModel_linear.i"), *get_model_sources()]
    ...
    # Build shared object
    ext = Extension(
        'caroModel_linear._caroModel_linear',
        sources=sources,
        include_dirs=ext_include_dirs,
        libraries=libraries,
        library_dirs=ext_library_dirs,
        swig_opts=[
            '-c++', '-modern', '-outdir', 'caroModel_linear',
...
# Install
setup(
    name='caroModel_linear',
    cmdclass=CMDCLASS,
    version='0.1.0',
    description='AMICI-generated module for model caroModel_linear',
